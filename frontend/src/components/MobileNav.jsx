...
const MobileNav = ({ currentHash }) => {
  const activeHash = currentHash || '#home';

  const getLinkClass = (hash) => {
    const isActive = activeHash === hash;
    return `flex flex-col items-center justify-center space-y-1 transition-colors ${isActive ? 'text-primary' : 'hover:text-primary'}`;
  };
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-[#111111] border-t border-gray-200 dark:border-gray-800 z-50 px-4 py-2 flex justify-between items-center text-[10px] font-medium text-gray-500 pb-safe">
      ...
      <a href="#journey" className={getLinkClass('#journey')}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
      ...
      <a href="#creative" className={getLinkClass('#creative')}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
      ...
      <a href="#more" className={getLinkClass('#more')}>
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
